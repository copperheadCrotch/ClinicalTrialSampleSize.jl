...
params = (
    ...
    (OneSampleMeanInferior(1.9, 2.5, -1, true), 11.255, 0.8, 0.5, 0.05),
    (OneSampleMeanSuperior(20, 15, 3), 54.369, 0.85, 5.5, 0.05),
    (OneSampleMeanSuperior(121, 119, 2.3, true), 857.934, 0.95, 3, 0.1),
)
...
params = (
    ...
    (OneSampleMeanEqual(1.94, 1.95, 0, true), 5947.569, 0.85, 0.25, 0.05),
)
